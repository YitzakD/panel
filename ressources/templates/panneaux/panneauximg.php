...
$filename = "Liste-des-panneaux-en-image.pdf";
...
<page backtop="5mm" backleft="10mm" backright="10mm" backbottom="5mm" footer="page">
	...
	<table id="mytable" class="mb-6">
		...
		<tr>
			...
			<td class="box-75 text-uppercase"><h3 class="document-title">Liste<br>paneaux imagées</h3></td>
                ...
                <?php foreach($communes as $commune): ?>
                    ...
                    <table class="table-stripped">
                        ...
                        <tr>
                            ...
                            <td class="box-80 bg-green">

                                <div><?= $item->geoloc; ?></div>
                                <small class="text-uppercase"><?= $item->etat; ?></small>
                    ...
                    <table id="mytable">
                        ...
                        <tr>
                            ...
                            <td class="empty-table text-center">
                                ...
                                <span class="text-grey">Vous n'avez aucun panneaux disponibles dans <?= $commune->cmune_title; ?></span>
