...
$proformascounter = count_all("bills");

$proformas = find_all("bills", " ORDER BY id DESC");
...
<page backtop="5mm" backleft="10mm" backright="10mm" backbottom="5mm">
	...
	<table id="mytable" class="mb-6">
		...
		<tr>
			...
			<td class="box-75 text-uppercase"><h3 class="document-title">Liste<br>factures</h3></td>
	...
	<table class="table-stripped">
        ...
        <?php foreach($proformas as $item): ?>
			...
			<tr>
				...
				<td class="box-31 text-capitalize bg-striped">
                    ...
                    <div class="text-uppercase"><?= '309F-' . date('jny',strtotime($item->created)) . '/' . $item->pf_id; ?></div>
                    <small class="text-grey text-uppercase"><?= $client->e_name; ?></small>

                </td>

                <td class="box-31 bg-striped"><?= number_format($item->agency_remised_ht_price, 0, '', '.'); ?></td>

                <td class="box-31 text-capitalize bg-striped">

                    <div><?= number_format($item->numeric_ttc_price, 0, '', '.'); ?></div>
                    <small class="text-grey"><?= 'TVA : ' . number_format($item->tva, 0, '', ' '); ?></small>
			...
			<tr>
                ...
                <td class="box-31 borderbottom bordertop"><?= number_format($item->agency_remised_ht_price, 0, '', '.'); ?> </td>
		...
		<tr>
			...
			<td colspan="4" class="empty-table text-center">
				...
				<span class="text-grey">Vous n'avez aucune factures pour le moment</span>
