...
$deposit = find_all("deposit", "init_id", $statement->id);

$filename = "Transaction-sur-BON-$commande->bc_id-($provider->p_name).pdf";
        ...
        <tr>
            ...
            <td class="box-75 text-uppercase">
                ...
                <h3 class="document-title">
                    ...
                    <div>Transaction sur BON</div>
                    <small class="text-grey"><?= 'BC-' . $commande->bc_id; ?></small>
    ...
    <table id="mytable">
        ...
        <tbody>
         ...
         <tr>
            ...
            <td class="box-25 text-uppercase ts-zx text-grey">Fournisseur</td>

            <td class="box-25 text-uppercase ts-zx text-grey text-center">Interlocuteur</td>

            <td class="box-25 text-uppercase ts-zx text-grey text-center">Adresse E-mail</td>

            <td class="box-25 text-uppercase ts-zx text-grey text-right">Téléphone</td>

        </tr>

        <tr>

            <td class="box-25"><?= $provider->p_name ?></td>

            <td class="box-25 text-center"><?= $provider->c_name ?></td>

            <td class="box-25 text-center"><?= $provider->p_mail; ?></td>

            <td class="box-25 text-right"><?= "+225 " . $provider->contacts; ?></td>
    ...
    <table id="mytable" class="mt-6 mb-6">
        ...
        <tbody>
         ...
         <tr>
            ...
            <td class="box-33 bordertop text-uppercase ts-zx text-grey text-center">Montant Dû</td>

            <td class="box-33 bordertop text-uppercase ts-zx text-grey text-center">Total versements</td>

            <td class="box-33 bordertop text-uppercase ts-zx text-grey text-center">Reste à payer</td>
        ...
        <?php $i = 1; ?>    
            ...
            <?php foreach($deposit as $item): ?>
                ...
                <tr>
                    ...
                    <td class="box-46-5 text-capitalize bg-striped">
                    
                        <div><?= date('j/n/Y ',strtotime($item->created)); ?></div>
                        <small class="text-grey"><?= set_time($item->created); ?></small>

                    </td>

                    <td class="box-46-5 bg-striped"><?= number_format($item->deposit_amount, 0, '', '.'); ?></td>
                ...
                <tr>
                    ...
                    <td class="box-46-5 text-capitalize borderbottom bordertop">
                    ...
                    <td class="box-46-5 borderbottom bordertop"><?= number_format($item->deposit_amount, 0, '', '.'); ?></td>
