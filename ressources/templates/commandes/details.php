...
$filename = "Informations-BC-$commande->bc_id-($provider->p_name).pdf";
...
<page backtop="5mm" backleft="10mm" backright="10mm" backbottom="5mm">
	...
	<table id="mytable" class="mb-5">
		...
		<tr>
			...
			<td class="box-75 text-uppercase">
                ...
                <h3 class="document-title">Bon de<br>commande</h3>
        ...
        <tr>
            ...
            <td class="box-50 bordertop">
                ...
                <span class="text-grey">
                    <div class="text-uppercase"><?= $provider->p_name; ?></div>
                    <small><?= $provider->c_name . ' (+225 ' . $provider->contacts . ')'; ?></small>
                </span>
            ...
            <td class="box-50 bordertop text-right">
                ...
                <span class="text-uppercase">BON N°</span><br>
                <span class="text-grey text-uppercase"><?= 'BC-' . $commande->bc_id; ?></span>
    ...
    <table class="table-invoice">
       ...
       <tbody>
        ...
        <tr>
            ...
            <td class="box-63 borderright">

            	<div><?= $commande->description; ?></div>
            	<small class="text-grey"><?= $commande->dating; ?></small>

            </td>
            
            <td class="box-7 borderright"><?= $commande->qte ?></td>

            <td class="box-15 borderright"><?= number_format($commande->pu, 0, '', '.'); ?></td>

            <td class="box-15 text-right"><?= number_format($commande->ht, 0, '', '.'); ?></td>
    ...
    <table class="table-invoice">
        ...
        <tr>
            ...
            <td class="box-80 borderright text-uppercase text-right">ODP</td>

            <td class="box-20 text-right"><?= number_format($commande->odp, 0, '', '.'); ?></td>

        </tr>

        <tr>
            
            <td class="box-80 borderright text-uppercase text-right">TM</td>

            <td class="box-20 text-right"><?= number_format($commande->tm, 0, '', '.'); ?></td>
        ...
        <tr>
            ...
            <td class="box-80 borderright text-uppercase text-right">Transport</td>

            <td class="box-20 text-right"><?= number_format($commande->transport, 0, '', '.'); ?></td>
        ...
        <tr>
            ...
            <td class="box-80 borderright text-uppercase text-right"><?= $commande->other_tax_name ?></td>

            <td class="box-20 text-right"><?= number_format($commande->other_tax_amount, 0, '', '.'); ?></td>
        ...
        <tr>
            ...
            <td class="box-20 text-right"><?= number_format($commande->tva, 0, '', '.'); ?></td>
        ...
        <tr>
            ...
            <td class="box-20 text-right"><?= number_format($commande->tsp, 0, '', '.'); ?></td>
    ...
    <table class="table-invoice">
        ...
        <tr><th scope="col" colspan="2" class="text-uppercase text-right">Montant total</th></tr>
        ...
        <tr>
            ...
            <td class="box-60">
                ...
                <small class="text-grey"><b class="text-danger">*</b> Tous les tarifs & montants sont exprimés en FCFA XOF</small>

            </td>

            <td class="box-40 text-right bg-green bolder ts-3x" style="color: #FFFFFF;"><?= number_format($commande->ttc, 0, '', '.'); ?></td>
