...
$commandescounter = count_all("bc");

$commandes = find_all("bc", "ORDER BY id DESC");
...
<page backtop="5mm" backleft="10mm" backright="10mm" backbottom="5mm">
	...
	<table id="mytable" class="mb-6">
		...
		<tr>
			...
			<td class="box-75 text-uppercase"><h3 class="document-title">Liste des commandes</h3></td>
	...
	<table class="table-stripped">
        ...
        <?php foreach($commandes as $item): ?>
			...
			<tr>
				...
				<td class="box-31 text-uppercase bg-striped">
                    
                    <div><?= "BC-" . $item->bc_id; ?></div>
                    <small class="text-grey"><?= $provider->p_name; ?></small>

                </td>

                <td class="box-31 bg-striped text-capitalize"><?= $item->description; ?></td>

                <td class="box-31 bg-striped">
                
                    <div><?= number_format($item->ttc, 0, '', '.') . ' TTC'; ?></div>
                    <small class="text-grey"><?= number_format($item->ht, 0, '', '.') . ' HT'; ?></small>
			...
			<tr>
				...
				<td class="box-31 text-uppercase borderbottom bordertop">
                ...
                <td class="box-31 borderbottom bordertop text-capitalize"><?= $item->description; ?></td>
		...
		<tr>
			...
			<td colspan="4" class="empty-table text-center">
				...
				<span class="text-grey">Vous n'avez aucun fournisseurs pour le moment</span>
