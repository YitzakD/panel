...
$fournisseurscounter = count_all("providers");

$fournisseurs = find_all("providers", "ORDER BY p_name ASC");

$filename = "Liste-des-fournisseurs.pdf";
...
<page backtop="5mm" backleft="10mm" backright="10mm" backbottom="5mm">
	...
	<table id="mytable" class="mb-6">
		...
		<tr>
			...
			<td class="box-75 text-uppercase"><h3 class="document-title">Liste<br>fournisseurs</h3></td>
	...
	<table class="table-stripped">
        ...
        <?php foreach($fournisseurs as $item): ?>
			...
			<tr>
                ...
                <td class="box-31 bg-striped"><?= $item->c_name; ?></td>
			...
			<tr>
                ...
                <td class="box-31 borderbottom bordertop"><?= $item->c_name; ?></td>
