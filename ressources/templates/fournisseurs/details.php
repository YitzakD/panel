...
$filename = "Informations-fournisseur-$fournisseur->p_name.pdf";
...
<page backtop="5mm" backleft="10mm" backright="10mm" backbottom="5mm">
		...
		<tr>
			...
			<td class="box-75 text-uppercase">
                ...
                <h3 class="document-title">
                    ...
                    <div><?= $fournisseur->p_name; ?></div>
                    <small class="text-grey">Fiche fournisseur</small>
    ...
    <table id="mytable">
        ...
        <tbody>
         ...
         <tr>
            ...
            <td class="box-33 text-uppercase ts-zx text-grey">Interlocuteur</td>

            <td class="box-33 text-uppercase ts-zx text-grey text-center">Téléphone</td>

            <td class="box-33 text-uppercase ts-zx text-grey text-right">Adresse E-mail</td>

        </tr>

        <tr>

            <td class="box-33"><?= $fournisseur->c_name ?></td>

            <td class="box-33 text-center"><?= "+225 " . $fournisseur->contacts; ?></td>

            <td class="box-33 text-right"><?= $fournisseur->p_mail; ?></td>
    ...
    <table id="mytable" class="mt-6">
        ...
        <tr>
            ...
            <td><small class="header-title"><?= $commandescounter > 1 ? "Bons" : "Bon"; ?> (<?= $commandescounter; ?>)</small></td>
    ...
    <table class="table-stripped">
        ...
        <?php foreach($commandes as $item): ?>
            ...
            <tr>
                ...
                <td class="box-68 text-capitalize bg-striped"><?=  $item->description; ?></td>

                <td class="box-25 bg-striped"><?= number_format($item->ttc, 0, '', '.'); ?></td>
            ...
            <tr>
                ...
                <td class="box-68 text-capitalize borderbottom bordertop"><?= $item->description; ?></td>

                <td class="box-25 borderbottom bordertop"><?= number_format($item->ttc, 0, '', '.'); ?></td>
        ...
        <tr>
            ...
            <td colspan="3" class="empty-table text-center">
                ...
                <span class="text-grey">Vous n'avez aucune commandes avec <?= $fournisseur->p_name; ?></span>
