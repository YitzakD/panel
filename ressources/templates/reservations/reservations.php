...
$reservationscounter = count_all("init_rsv");

$reservations = find_all("init_rsv", "ORDER BY id DESC");

$filename = "Liste-des-réservations.pdf";
...
<page backtop="5mm" backleft="10mm" backright="10mm" backbottom="5mm">
	...
	<table id="mytable" class="mb-6">
		...
		<tr>
			...
			<td class="box-75 text-uppercase"><h3 class="document-title">Liste<br>réservations</h3></td>
	...
	<table class="table-stripped">
		...
		<tr>
			...
			<td colspan="4" class="empty-table text-center">
				...
				<span class="text-grey">Vous n'avez aucune réservations pour le moment</span>
