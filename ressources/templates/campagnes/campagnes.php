...
$campagnescounter = count_all("init_rsv");

$campagnes = find_all("init_rsv", "WHERE etat!='En attente' ORDER BY id DESC");

$filename = "Liste-des-campagnes.pdf";
...
<page backtop="5mm" backleft="10mm" backright="10mm" backbottom="5mm">
	...
	<page_footer>
	<span style="width:100%; font-size:.83rem; color:#898989;">Liste des campagnes <?= WEBSITE_NAME; ?></span>
	</page_footer>
	...
	<table id="mytable" class="mb-6">
		...
		<tr>
			...
			<td class="box-75 text-uppercase"><h3 class="document-title">Liste des campagnes</h3></td>
	...
	<table class="table-stripped">
		...
		<?php if($campagnescounter > 0): ?>

        <?php $i = 1; ?>
		
        <?php foreach($campagnes as $item): ?>
			...
			<tr>
				...
				<td class="box-31 text-capitalize bg-striped">
                    ...
                    <small class="text-grey"><?= $item->etat === "Closed" ? "Campagne terminée" : $item->etat; ?></small>
                ...
                <td class="box-31 bg-striped">
                    ...
                    <small class="text-grey"><?= setAtype($client->type); ?></small>
		...
		<tr>
			...
			<td colspan="4" class="empty-table text-center">
				...
				<span class="text-grey">Vous n'avez aucune campagnes pour le moment</span>
