...
$filename = "Informations-campagne-$client->e_name-($campagne->camp_name).pdf";
...
<page backtop="5mm" backleft="10mm" backright="10mm" backbottom="5mm">
	...
	<page_footer>
	<span style="width:100%; font-size:.83rem; color:#898989;">Information sur campagne <?= $campagne->camp_name; ?></span>
	</page_footer>
		...
		<tr>
			...
			<td class="box-75 text-uppercase">
                ...
                <h3 class="document-title">
                    ...
                    <div><?= $campagne->camp_name; ?></div>
                    <small class="text-grey">Fiche de campagne</small>
    ...
    <table id="mytable">
        ...
        <tr>
            ...
            <td class="box-33 text-center"><?= date('j/n/Y ',strtotime($campagne->debut)); ?></td>

            <td class="box-33 text-right"><?= date('j/n/Y ',strtotime($campagne->fin)); ?></td>
    ...
    <table class="table-stripped">
        ...
        <?php foreach($rsvd_nbr as $item): ?>
            ...
            <tr>
                ...
                <td class="box-90 text-capitalize bg-striped"><?= $sbinfo->geoloc; ?></td>
            ...
            <tr>
                ...
                <td class="box-90 text-capitalize borderbottom bordertop"><?= $sbinfo->geoloc; ?></td>
        ...
        <tr>
            ...
            <td colspan="3" class="empty-table text-center">
                ...
                <span class="text-grey">Cette campagne n'a aucun panneaux pour le moment</span>
