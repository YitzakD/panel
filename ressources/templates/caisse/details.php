...
$readablemonth = month_convert($caisse->month);

$filename = "Caisse-$readablemonth-($caisse->year).pdf";
        ...
        <tr>
            ...
            <td class="box-75 text-uppercase">
                ...
                <h3 class="document-title">
                    ...
                    <div><?= $readablemonth . " " . $caisse->year; ?></div>
                    <small class="text-grey">Fiche de Caise</small>
    ...
    <table id="mytable" class="mt-6 mb-6">
        ...
        <tbody>
         ...
         <tr>
            ...
            <td class="box-25 bordertop text-uppercase ts-zx text-grey text-center">Reliquat</td>

            <td class="box-25 bordertop text-uppercase ts-zx text-grey text-center">Débit</td>

            <td class="box-25 bordertop text-uppercase ts-zx text-grey text-center">Crédit</td>

            <td class="box-25 bordertop text-uppercase ts-zx text-grey text-center">Solde</td>

        </tr>

        <tr>

            <td class="box-25 ts-2x bolder text-center"><?= number_format($point->mo_new_solde, 0, '', '.'); ?></td>

            <td class="box-25 ts-2x bolder text-center"><?= number_format($point->mo_in, 0, '', '.'); ?></td>

            <td class="box-25 ts-2x bolder text-center"><?= number_format($point->mo_out, 0, '', '.'); ?></td>

            <td class="box-25 ts-2x bolder text-center"><?= number_format($point->mo_solde, 0, '', '.'); ?></td>
    ...
    <table class="table-invoice">
        ...
        <?php $i = 1; ?>    
            ...
            <?php foreach($caisses as $item): ?>
                ...
                <tr>
                    ...
                    <td class="box-15 borderleft borderright bg-striped"><?= $item->day . '/' . $caisse->month . '/' . $caisse->year; ?></td>

                    <td class="box-25 borderright bg-striped">

                    	<div><?= number_format($item->amount, 0, '', '.'); ?></div>
                    	<?= $item->typeof == '1' ? '<small class="text-green">Entrée</small>' : '<small class="text-danger">Sortie</small>'; ?>

                    </td>

                    <td class="box-60 borderright text-capitalize bg-striped"><?= $item->description; ?></td>
                ...
                <tr>
                    ...
                    <td class="box-15 borderleft borderright borderbottom bordertop"><?= $item->day . '/' . $caisse->month . '/' . $caisse->year; ?></td>

                    <td class="box-25 borderright borderbottom bordertop">
                    ...
                    <td class="box-60 borderright text-capitalize borderbottom bordertop"><?= $item->description; ?></td>
        ...
        <tr>
            ...
            <td colspan="3" class="empty-table text-center">
                ...
                <span class="text-grey">Vous n'avez reçu aucun mouvements pour le moment</span>
