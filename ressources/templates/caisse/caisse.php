...
$caissescounter = count_all("init_caisse");

$caisse= find_all("init_caisse", " ORDER BY id DESC");

$filename = "Liste-des-caisses.pdf";
...
<page backtop="5mm" backleft="10mm" backright="10mm" backbottom="5mm">
	...
	<table id="mytable" class="mb-6">
		...
		<tr>
			...
			<td class="box-75 text-uppercase"><h3 class="document-title">Liste<br>caisses</h3></td>
	...
	<table class="table-stripped">
        ...
        <?php foreach($caisse as $item): ?>
			...
			<tr>
                ...
                <td class="box-25 bg-striped"><?= number_format($pointcaisse->mo_new_solde + $pointcaisse->mo_in, 0, '', '.'); ?></td>

                <td class="box-25 text-capitalize bg-striped"><?= number_format($pointcaisse->mo_out, 0, '', '.'); ?></td>
        
                <td class="box-25 bg-striped"><?= number_format($pointcaisse->mo_solde, 0, '', '.'); ?></td>
			...
			<tr>
				...
				<td class="box-25 text-capitalize borderbottom bordertop"><?= number_format($pointcaisse->mo_new_solde + $pointcaisse->mo_in, 0, '', '.'); ?></td>

                <td class="box-25 borderbottom bordertop"><?= number_format($pointcaisse->mo_out, 0, '', '.'); ?></td>

                <td class="box-25 text-capitalize borderbottom bordertop"><?= number_format($pointcaisse->mo_solde, 0, '', '.'); ?></td>
		...
		<tr>
			...
			<td colspan="4" class="empty-table text-center">
				...
				<span class="text-grey">Vous n'avez aucune caisses pour le moment</span>
