...
$sboards = find_all("signboards", " WHERE ville='$ID' ORDER BY nbr");

$zone = find_one("zones", "id", $ville->zid);

$filename = "Informations-ville-$ville->city_title.pdf";
...
<page backtop="5mm" backleft="10mm" backright="10mm" backbottom="5mm">
		...
		<tr>
			...
			<td class="box-75 text-uppercase">
                ...
                <h3 class="document-title">
                    ...
                    <div><?= $ville->city_title; ?></div>
                    <small class="text-grey">Fiche ville</small>
	...
	<table id="mytable" class="mt-6 mb-3">
        ...
        <tr>
            ...
            <td class="box-50 bordertop text-uppercase ts-zx text-grey text-center"><?= $cmunescounter > 1 ? "Communes" : "Commune"; ?></td>

            <td class="box-50 bordertop text-uppercase ts-zx text-grey text-center"><?= $sboardscounter > 1 ? "Panneaux" : "Panneau"; ?></td>

        </tr>

        <tr>

            <td class="box-50 text-center ts-4x bolder"><?= $cmunescounter ?></td>

            <td class="box-50 text-center ts-4x bolder"><?= $sboardscounter ?></td>
