...
$villescounter = count_all("cities", "WHERE id>1");

$villes = find_all("cities", "WHERE id>1");

$filename = "Liste-des-villes.pdf";
...
<page backtop="5mm" backleft="10mm" backright="10mm" backbottom="5mm">
	...
	<table id="mytable" class="mb-6">
		...
		<tr>
			...
			<td class="box-75 text-uppercase"><h3 class="document-title">Liste<br>villes</h3></td>
	...
	<table class="table-stripped">
		...
		<?php foreach($villes as $item): ?>
			...
			<tr>
				...
				<td class="box-46-5 text-capitalize bg-striped"><?= $item->city_title; ?></td>

                <td class="box-46-5 text-capitalize bg-striped"><?= $zone->zone_title; ?></td>
			...
			<tr>
				...
				<td class="box-46-5 text-capitalize borderbottom bordertop"><?= $item->city_title; ?></td>

                <td class="box-46-5 text-capitalize borderbottom bordertop"><?= $zone->zone_title; ?></td>
