...
$signboards = find_signboards($commune->zid, $ID, "");

$zone = find_one("zones", "id", $commune->zid);

$ville = find_one("cities", "id", $commune->vid);

$filename = "Informations-commune-$commune->cmune_title.pdf";
...
<page backtop="5mm" backleft="10mm" backright="10mm" backbottom="5mm">
		...
		<tr>
			...
			<td class="box-75 text-uppercase">
                ...
                <h3 class="document-title">
                    ...
                    <div><?= $commune->cmune_title; ?></div>
                    <small class="text-grey">Fiche commune</small>
	...
	<table id="mytable" class="mt-6 mb-3">
        ...
        <tr>
            ...
            <td class="box-33 bordertop text-uppercase ts-zx text-grey text-center">Zone</td>

            <td class="box-33 bordertop text-uppercase ts-zx text-grey text-center">Ville</td>

            <td class="box-33 bordertop text-uppercase ts-zx text-grey text-center"><?= $signboardscounter > 1 ? "Panneaux" : "Panneau"; ?></td>

        </tr>

        <tr>

            <td class="box-33 text-center ts-4x bolder"><?= $zone->zone_title ?></td>

            <td class="box-33 text-center ts-4x bolder"><?= $ville->city_title ?></td>

            <td class="box-33 text-center ts-4x bolder"><?= $signboardscounter ?></td>
