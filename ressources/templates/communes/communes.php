...
$cmunescounter = count_all("cmunes", "WHERE id>1");

$communes = find_all("cmunes", "WHERE id>1");

$filename = "Liste-des-communes.pdf";
...
<page backtop="5mm" backleft="10mm" backright="10mm" backbottom="5mm">
	...
	<table id="mytable" class="mb-6">
		...
		<tr>
			...
			<td class="box-75 text-uppercase"><h3 class="document-title">Liste<br>communes</h3></td>
	...
	<table class="table-stripped">
		...
		<?php foreach($communes as $item): ?>
            ...
            <?php $ville = find_one("cities", "id", $item->vid); ?>

            <?php $zone = find_one("zones", "id", $item->zid); ?>
			...
			<tr>
				...
				<td class="box-31 text-capitalize bg-striped"><?= $item->cmune_title; ?></td>

                <td class="box-31 text-capitalize bg-striped"><?= $ville->city_title; ?></td>

                <td class="box-31 text-capitalize bg-striped"><?= $zone->zone_title; ?></td>
			...
			<tr>
				...
				<td class="box-31 text-capitalize borderbottom bordertop"><?= $item->cmune_title; ?></td>

                <td class="box-31 text-capitalize borderbottom bordertop"><?= $ville->city_title; ?></td>

                <td class="box-31 text-capitalize borderbottom bordertop"><?= $zone->zone_title; ?></td>
