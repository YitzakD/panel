...
$sizescounter = count_all("sizes", "WHERE id>1");

$sizes = find_all("sizes", "WHERE id>1");

$filename = "Liste-des-formats.pdf";
...
<page backtop="5mm" backleft="10mm" backright="10mm" backbottom="5mm">
	...
	<table id="mytable" class="mb-6">
		...
		<tr>
			...
			<td class="box-75 text-uppercase"><h3 class="document-title">Liste<br>formats</h3></td>
	...
	<table class="table-stripped">
		...
		<?php foreach($sizes as $item): ?>
			...
			<tr>
				...
				<td class="box-93 text-capitalize bg-striped"><?= $item->size . "m²"; ?></td>
			...
			<tr>
				...
				<td class="box-93 text-capitalize borderbottom bordertop"><?= $item->size . "m²"; ?></td>
		...
		<tr>
			...
			<td colspan="2" class="empty-table text-center">
				...
				<span class="text-grey">Vous n'avez aucun formats pour le moment</span>
