...
$userscounter = count_all("users", "WHERE id>1");

$users = find_all("users", "WHERE id>1");
...
<page backtop="5mm" backleft="10mm" backright="10mm" backbottom="5mm">
	...
	<table id="mytable" class="mb-6">
		...
		<tr>
			...
			<td class="box-75 text-uppercase"><h3 class="document-title">Liste<br>utilisateurs</h3></td>
	...
	<table class="table-stripped">
        ...
        <?php foreach($users as $item): ?>
			...
			<tr>
				...
				<td class="box-31 text-capitalize bg-striped">
                    ...
                    <small class="text-grey text-uppercase"><?= $utype->utype_name; ?></small>

                </td>

                <td class="box-50 bg-striped"><?= $item->email; ?></td>

                <td class="box-12 text-capitalize bg-striped"><?= $item->active > 0 ? "Actif" : "Non acti"; ?></td>
			...
			<tr>
                ...
                <td class="box-50 borderbottom bordertop"><?= $item->email; ?></td>

                <td class="box-12 text-capitalize borderbottom bordertop"><?= $item->active > 0 ? "Actif" : "Non acti"; ?></td>
		...
		<tr>
			...
			<td colspan="4" class="empty-table text-center">
				...
				<span class="text-grey">Vous n'avez aucune zones pour le moment</span>
