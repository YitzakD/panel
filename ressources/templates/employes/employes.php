...
$employescounter = count_all("employees");

$employes = find_all("employees", "ORDER BY emp_names ASC");

$filename = "Liste-des-employes.pdf";
...
<page backtop="5mm" backleft="10mm" backright="10mm" backbottom="5mm">
	...
	<table id="mytable" class="mb-6">
		...
		<tr>
			...
			<td class="box-75 text-uppercase"><h3 class="document-title">Liste des employés</h3></td>
	...
	<table id="mytable" class="mt-6"><tbody><tr><td class="box-h-2 bordertop"></td></tr></tbody></table>
        ...
        <?php foreach($employes as $item): ?>
			...
			<tr>
				...
				<td class="box-31 text-capitalize bg-striped">
                    ...
                    <small class="text-grey text-uppercase"><?= $item->matr; ?></small>

                </td>

                <td class="box-31 bg-striped">
                    
                    <div><?= $item->occ_poste; ?></div>
                    <small class="text-grey">Dépuis le <?= date('j/n/Y ',strtotime($item->emb_date)); ?></small>

                </td>

                <td class="box-31 text-capitalize bg-striped">
                
                    <div><?= '+225' . '&nbsp;' . $item->add_phone; ?></div>
                    <small class="text-grey"><?= $item->dev_mail; ?></small>
