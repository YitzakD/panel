...
$filename = "Informations-employe-$employe->emp_names.pdf";
...
<page backtop="5mm" backleft="10mm" backright="10mm" backbottom="5mm">
		...
		<tr>
			...
			<td class="box-75 text-uppercase">
                ...
                <h3 class="document-title">
                    ...
                    <div><?= $employe->emp_names; ?></div>
                    <small class="text-grey">Fiche employé</small>
    ...
    <table id="mytable">
        ...
        <tbody>
         ...
         <tr>
            ...
            <td class="box-33 text-uppercase ts-zx text-grey">Matricule</td>

            <td class="box-33 text-uppercase ts-zx text-grey text-center">Téléphone</td>

            <td class="box-33 text-uppercase ts-zx text-grey text-right">Adrese E-mail</td>

        </tr>

        <tr>

            <td class="box-33"><?= "+225 " . $employe->matr ?></td>

            <td class="box-33 text-center"><?= "+225 " . $employe->add_phone; ?></td>

            <td class="box-33 text-right"><?= $employe->dev_mail; ?></td>
    ...
    <table id="mytable" class="mt-6 mb-3">
        ...
        <tr>
            ...
            <td class="box-33 bordertop text-uppercase ts-zx text-grey text-center">Type de contrat</td>

            <td class="box-33 bordertop text-uppercase ts-zx text-grey text-center">Dépuis le</td>

            <td class="box-33 bordertop text-uppercase ts-zx text-grey text-center">Salaire</td>

        </tr>

        <tr>

            <td class="box-33 text-center ts-4x bolder"><?= $employe->contract_type ?></td>

            <td class="box-33 text-center ts-4x bolder"><?= date('j/n/Y ',strtotime($employe->emb_date)); ?></td>

            <td class="box-33 text-center ts-4x bolder"><?= number_format($employe->salary, 0, '', '.'); ?></td>
