...
$clientscounter = count_all("clients");

$clients = find_all("clients", "ORDER BY e_name ASC");
...
<page backtop="5mm" backleft="10mm" backright="10mm" backbottom="5mm">
	...
	<table id="mytable" class="mb-6">
		...
		<tr>
			...
			<td class="box-75 text-uppercase"><h3 class="document-title">Liste<br>clients</h3></td>
	...
	<table class="table-stripped">
        ...
        <?php foreach($clients as $item): ?>
			...
			<tr>
				...
				<td class="box-25 text-capitalize bg-striped">
                    ...
                    <div><?= ucfirst($item->e_name); ?></div>
                    <small class="text-grey"><?= setAtype($item->type); ?></small>

                </td>

                <td class="box-25 bg-striped text-capitalize"><?= $item->c_name; ?></td>

                <td class="box-43 bg-striped">
                
                    <div><?= $item->a_mail; ?></div>
                    <small class="text-grey"><?= '+225' . '&nbsp;' . $item->contacts; ?></small>
			...
			<tr>
				...
				<td class="box-25 text-capitalize borderbottom bordertop">
                ...
                <td class="box-25 borderbottom bordertop text-capitalize"><?= $item->c_name; ?></td>

                <td class="box-43 borderbottom bordertop">
		...
		<tr>
			...
			<td colspan="4" class="empty-table text-center">
				...
				<span class="text-grey">Vous n'avez aucun clients pour le moment</span>
