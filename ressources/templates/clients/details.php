...
$campcounter = cell_count("init_rsv", "client_id", $ID, "AND etat!='En attente'");

$rsvcounter = cell_count("init_rsv", "client_id", $ID);

$invoicecounter = cell_count("bills", "client_id", $ID);

$invoices = find_all("bills", " WHERE client_id='$ID' ORDER BY id DESC");

$proformacounter = cell_count("pformas", "client_id", $ID);

$proformas = find_all("pformas", " WHERE client_id='$ID' ORDER BY id DESC");

$filename = "Informations-client-$client->e_name.pdf";
...
<page backtop="5mm" backleft="10mm" backright="10mm" backbottom="5mm">
		...
		<tr>
			...
			<td class="box-75 text-uppercase">
                ...
                <h3 class="document-title">
                    ...
                    <div><?= $client->e_name; ?></div>
                    <small class="text-grey">Fiche client</small>
    ...
    <table id="mytable">
        ...
        <tbody>
         ...
         <tr>
            ...
            <td class="box-33 text-uppercase ts-zx text-grey">Téléphone</td>

            <td class="box-33 text-uppercase ts-zx text-grey text-center">Boîte postale</td>

            <td class="box-33 text-uppercase ts-zx text-grey text-right">Compte contribuable</td>

        </tr>

        <tr>

            <td class="box-33"><?= "+225 " . $client->contacts ?></td>

            <td class="box-33 text-center"><?= $client->bp != "" ? $client->bp : "---" ?></td>

            <td class="box-33 text-right"><?= $client->cc != "" ? $client->cc : "---" ?></td>
    ...
    <table id="mytable" class="mt-6 mb-3">

        <tbody>

        <tr>

            <td class="box-33 bordertop text-uppercase ts-zx text-grey text-center"><?= $campcounter > 1 ? "Campagnes" : "Campagne"; ?></td>

            <td class="box-33 bordertop text-uppercase ts-zx text-grey text-center"><?= $rsvcounter > 1 ? "Réservations" : "Réservation"; ?></td>

            <td class="box-33 bordertop text-uppercase ts-zx text-grey text-center"><?= $invoicecounter > 1 ? "facturations" : "facturation"; ?></td>

        </tr>

        <tr>

            <td class="box-33 text-center ts-4x bolder"><?= $campcounter ?></td>

            <td class="box-33 text-center ts-4x bolder"><?= $rsvcounter ?></td>

            <td class="box-33 text-center ts-4x bolder"><?= $invoicecounter ?></td>
    ...
    <table id="mytable" class="mt-6">
        ...
        <tr>
            ...
            <td><small class="header-title"><?= $proformacounter > 1 ? "Pro-formas" : "Pro-forma"; ?> (<?= $proformacounter; ?>)</small></td>
    ...
    <table class="table-stripped">
        ...
        <?php foreach($proformas as $item): ?>
            ...
            <tr>
                ...
                <td class="box-46-5 text-uppercase bg-striped"><?= "Pro-forma N.<b>" . $item->pf_id . "</b>"; ?></td>

                <td class="box-46-5 bg-striped"><?= number_format($item->numeric_ttc_price, 0, '', '.'); ?></td>
            ...
            <tr>
                ...
                <td class="box-46-5 text-uppercase borderbottom bordertop"><?= "Pro-forma N.<b>" . $item->pf_id . "</b>"; ?></td>

                <td class="box-46-5 borderbottom bordertop"><?= number_format($item->numeric_ttc_price, 0, '', '.'); ?></td>
        ...
        <tr>
            ...
            <td colspan="2" class="empty-table text-center">

                <h2>Tableau vide!</h2>

                <span class="text-grey">Ce client n'a aucune pro-formas pour le moment</span>
    ...
    <table id="mytable" class="mt-6">
        ...
        <tr>
            ...
            <td><small class="header-title"><?= $invoicecounter > 1 ? "Factures" : "Facture"; ?> (<?= $invoicecounter; ?>)</small></td>
    ...
    <table class="table-stripped">
        ...
        <?php foreach($invoices as $item): ?>
            ...
            <tr>
                ...
                <td class="box-46-5 bg-striped text-uppercase">FACTURE N.<?= '309F-' . date('jny',strtotime($item->created)) . '/<b>' . $item->pf_id . '</b>'; ?></td>
            ...
            <tr>
                ...
                <td class="box-7 borderbottom bordertop"><?= "DEV-" . $item->nbr; ?></td>

                <td class="box-46-5 borderbottom bordertop">FACTURE N.<?= '309F-' . date('jny',strtotime($item->created)) . '/<b>' . $item->pf_id . '</b>'; ?></td>
        ...
        <tr>
            ...
            <td colspan="4" class="empty-table text-center">
                ...
                <span class="text-grey">Ce client n'a aucune factures pour le moment</span>
