...
<page backtop="5mm" backleft="10mm" backright="10mm" backbottom="5mm">
	...
	<table id="mytable" class="mb-6">
		...
		<tr>
			...
			<td class="box-75 text-uppercase"><h3 class="document-title">Liste<br>zones</h3></td>
	...
	<table class="table-stripped">
		...
		<?php foreach($zones as $item): ?>
			...
			<tr>
				...
				<td class="box-93 text-capitalize bg-striped"><?= $item->zone_title; ?></td>
			...
			<tr>
				...
				<td class="box-93 text-capitalize borderbottom bordertop"><?= $item->zone_title; ?></td>
