...
$villes = find_all("cities", " WHERE zid='$ID' ORDER BY id DESC");

$cmunescounter = cell_count("cmunes", "zid", $ID);

$communes = find_all("cmunes", " WHERE zid='$ID' ORDER BY id DESC");

$sboardscounter = cell_count("signboards", "zone", $ID);

$sboards = find_all("signboards", " WHERE zone='$ID' ORDER BY nbr");

$filename = "Informations-zone-$zone->zone_title.pdf";
...
<page backtop="5mm" backleft="10mm" backright="10mm" backbottom="5mm">
		...
		<tr>
			...
			<td class="box-75 text-uppercase">
                ...
                <h3 class="document-title">
                    ...
                    <div><?= $zone->zone_title; ?></div>
                    <small class="text-grey">Fiche zone</small>
	...
	<table id="mytable" class="mt-6 mb-3">
        ...
        <tr>
            ...
            <td class="box-33 bordertop text-uppercase ts-zx text-grey text-center"><?= $villescounter > 1 ? "Villes" : "Ville"; ?></td>

            <td class="box-33 bordertop text-uppercase ts-zx text-grey text-center"><?= $cmunescounter > 1 ? "Communes" : "Commune"; ?></td>

            <td class="box-33 bordertop text-uppercase ts-zx text-grey text-center"><?= $sboardscounter > 1 ? "Panneaux" : "Panneau"; ?></td>

        </tr>

        <tr>

            <td class="box-33 text-center ts-4x bolder"><?= $villescounter ?></td>

            <td class="box-33 text-center ts-4x bolder"><?= $cmunescounter ?></td>

            <td class="box-33 text-center ts-4x bolder"><?= $sboardscounter ?></td>
    ...
    <table id="mytable" class="mt-6">
        ...
        <tr>
            ...
            <td><small class="header-title"><?= $villescounter > 1 ? "Villes" : "Ville"; ?> (<?= $villescounter; ?>)</small></td>
	...
	<table class="table-stripped">
		...
		<?php foreach($villes as $item): ?>
			...
			<tr>
				...
				<td class="box-93 text-capitalize bg-striped"><?= $item->city_title; ?></td>
			...
			<tr>
				...
				<td class="box-93 text-capitalize borderbottom bordertop"><?= $item->city_title; ?></td>
		...
		<tr>
			...
			<td colspan="2" class="empty-table text-center">
				...
				<span class="text-grey">Vous n'avez aucune villes pour le moment</span>
    ...
    <table id="mytable" class="mt-3">
        ...
        <tr>
            ...
            <td><small class="header-title"><?= $cmunescounter > 1 ? "Communes" : "Commune"; ?> (<?= $cmunescounter; ?>)</small></td>
    ...
    <table class="table-stripped">
        ...
        <?php foreach($communes as $item): ?>
            ...
            <tr>
                ...
                <td class="box-93 text-capitalize bg-striped"><?= $item->cmune_title; ?></td>
            ...
            <tr>
                ...
                <td class="box-93 text-capitalize borderbottom bordertop"><?= $item->cmune_title; ?></td>
        ...
        <tr>
            ...
            <td colspan="2" class="empty-table text-center">
                ...
                <span class="text-grey">Vous n'avez aucune communes pour le moment</span>
    ...
    <table id="mytable" class="mt-3">
        ...
        <tr>
            ...
            <td><small class="header-title"><?= $sboardscounter > 1 ? "Panneaux" : "Panneau"; ?> (<?= $sboardscounter; ?>)</small></td>
    ...
    <table class="table-stripped">
        ...
        <?php foreach($sboards as $item): ?>
            ...
            <tr>
                ...
                <td class="box-10 bg-striped"><?= $size->size . "m²"; ?></td>

                <td class="box-60 text-capitalize bg-striped"><?= $item->geoloc; ?></td>

                <td class="box-20 text-uppercase text-uppercase bg-striped"><?= $item->etat; ?></td>
            ...
            <tr>
                ...
                <td class="box-10 borderbottom bordertop"><?= $size->size . "m²"; ?></td>

                <td class="box-60 text-capitalize borderbottom bordertop"><?= $item->geoloc; ?></td>

                <td class="box-20 text-uppercase borderbottom bordertop text-uppercase"><?= $item->etat; ?></td>
