...
$filename = "Disponibilité-actuelle.pdf";
		...
		<tr>
			...
			<td class="box-75 text-uppercase">
                ...
                <h3 class="document-title">
                    ...
                    <small class="text-grey">actuelle</small>
        ...
        <?php foreach($zones as $zone): ?>
            ...
            <?php if($communescounter > 0): ?>
                ...
                <?php foreach($communes as $commune): ?>
                    ...
                    <?php $fsbcounter = find_fsignboards_nbr($zone->id, $commune->id, $size, $state); ?>
                        
                    <?php $bfsbounter = find_signboards_tbf_nbr($debut, $fin, $zone->id, $commune->id, $size, $state); ?>

                    <?php $tdsbcounter = $fsbcounter + $bfsbounter; ?>

                    <?php $fsboards = find_fsignboards($zone->id, $commune->id, $size, $state); ?>

                    <?php $bfsboards = find_signboards_tbf($debut, $fin, $zone->id, $commune->id, $size, $state); ?>
        ...
        <table id="mytable">
            ...
            <tbody><tr>
                ...
                <td class="empty-table text-center">
                    ...
                    <span class="text-grey">Vous n'avez aucune zones définies</span>
