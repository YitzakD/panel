...
$filename = "Disponibilié-du-$readeable_indate-au-$readeable_outdate.pdf";
...
<page backtop="5mm" backleft="10mm" backright="10mm" backbottom="5mm" footer="page;">
    ...
    <table id="mytable">
        ...
        <tr>
            ...
            <td class="box-33 text-right">Liste</td>
            ...
            <?php foreach($communes as $commune): ?>
                ...
                <table class="table-stripped mb-5">
                    ...
                    <tr>
                        ...
                        <td class="box-80 text-capitalize bg-striped"><?= $item->geoloc; ?></td>
                    ...
                    <tr>
                        ...
                        <td class="box-80 text-capitalize borderbottom bordertop"><?= $item->geoloc; ?></td>
