				...
				<table class="table table-striped p-datatable">
					...
					<thead>
						...
						<tr>
							...
							<td scope="row"><?= date('j/n/Y ',strtotime($item->created)); ?></td>
							
							<td scope="row"><?= number_format($item->deposit_amount, 0, '', ' '); ?></td>
								...
								<div class="modal fade p-confirm-modal-sm" id="myModal<?= $item->id ?>" tabindex="-1" role="dialog" aria-labelledby="Teste" aria-hidden="true">
									...
									<div class="modal-dialog modal-sm modal-dialog-centered" role="document">
										...
										<div class="modal-content">
											...
											<form action="<?= WURI . '?r=' . $m[1] . '/suppression/depot/' . $ID. '/'; ?>" method="post" class="p-3 mb-2">
						...
						<?php else: ?>
							...
							<tr>
								...
								<td colspan="6" class="p-datatable-empty">
									...
									<p>Vous n'avez effectuer aucun versements pour cette commande pour le moment</p>
			...
			<table class="table table-sm p-datatable table-dark">
				...
				<thead>
					...
					<tr>
 						...
 						<th scope="col">Montant dû (Fcfa)</th>

 						<th scope="col">Total Verséments (Fcfa)</th>

 						<th scope="col">Reste à Payer (Fcfa)</th>
