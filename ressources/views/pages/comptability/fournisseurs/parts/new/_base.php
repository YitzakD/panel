	...
	<div class="p-portlet-body">
		...
		<form action="" method="post" class="p-form-table">
			...
			<div class="form-group mb-3<?= !empty($error) && count($error[1]) != 0 ? ' has-error' : '';  ?>">
				...
				<input type="text" name="provider" id="provider" class="form-control p-form-ctrl p-form-ctrl-sm" value="<?= get_input("provider"); ?>" placeholder="Entrez le nom" autofocus required />
			...
			<div class="form-group mb-3<?= !empty($error) && count($error[2]) != 0 ? ' has-error' : '';  ?>">
				...
				<input type="text" name="corresponding" id="corresponding" class="form-control p-form-ctrl p-form-ctrl-sm" value="<?= get_input("corresponding"); ?>" placeholder="Entrez le nom de l'interlocuteur" required />
			...
			<div class="form-group mb-3<?= !empty($error) && count($error[3]) != 0 ? ' has-error' : '';  ?>">
				...
				<input type="email" name="pemail" id="pemail" class="form-control p-form-ctrl p-form-ctrl-sm" value="<?= get_input("pemail"); ?>" placeholder="Entrez l'adresse e-mail de l'interlocuteur" required />
			...
			<div class="form-group mb-3<?= !empty($error) && count($error[4]) != 0 ? ' has-error' : '';  ?>">
				...
				<input type="number" name="phones" id="phones" class="form-control p-form-ctrl p-form-ctrl-sm" value="<?= get_input("phones"); ?>" placeholder="Entrez le numéro de téléphonique." required />
