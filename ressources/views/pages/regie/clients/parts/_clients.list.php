		...
		<div class="p-portlet rounded">
			...
			<div class="p-portlet-head">
				...
				<div class="p-portlet-head-label">
					<h3>Ajouté récemment<small class="p-hidden">Total <?= $clientscounter__; ?></small></h3>
				</div>
			...
			<div class="d-block pt-4 pb-4">
				...
				<table class="table table-striped p-datatable" id="sb-search-table">
				
					<thead>

    					<tr>

      						<th scope="col" class="p-hidden">#</th>
 					...
 					<?php if($clientscounter__ > 0): ?>

 						<?php foreach($clients__ as $item): ?>

 						<tr>
 							
 							<td scope="row" class="p-hidden"><?= $i++; ?></td>
 							...
 							<td>
								...
								<span class="d-inline-block">
									...
									<small class="d-block text-muted p-hidden"><?= setAtype($item->type); ?></small>
								</span>
 							...
 							<td>
 								...
 								<?= $item->a_mail; ?>
 								<small class="d-block text-muted"><?= '+225' . '&nbsp;' . $item->contacts; ?></small>
 					...
 					<?php else: ?>
 						...
 						<tr>
 							...
 							<td colspan="6" class="p-datatable-empty">
 								...
 								<p>Vous n'avez aucun clients pour le moment</p>
