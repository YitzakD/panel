...
<div class="p-portlet-wizard-form">
	...
	<div class="row no-gutters">
		...
		<div class="col-12 col-md-6 col-lg-6 mb-4">
			...
			<h3 class="h4 text-uppercase"><?= $reservation->camp_name; ?></h3>
		...
		<div class="col-12 col-md-6 col-lg-6 mb-4">
			...
			<h3 class="h4 text-uppercase"><?= date('j/n/Y ',strtotime($reservation->debut)); ?></h3>
		...
		<div class="col-12 col-md-6 col-lg-6 mb-4">
			...
			<h3 class="h4 text-uppercase"><?= date('j/n/Y ',strtotime($reservation->fin)); ?></h3>
