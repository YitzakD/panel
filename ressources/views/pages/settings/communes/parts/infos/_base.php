		...
		<div class="p-portlet rounded">
			...
			<div class="p-portlet-head">
				...
				<div class="p-portlet-head-label">
					<?php $in = explode(" ", $commune->cmune_title); ?>
					...
					<span class="d-inline-block">
						<div class="text-uppercase"><?= $commune->cmune_title; ?></div>
						<span class="d-block small text-muted"><?= $ville->city_title; ?></span>
					</span>
			...
			<div>
				...
				<div class="row p-display-details">
					...
					<div class="col-12 col-md-4 col-lg-4">
						...
						<div class="counter"><?= $zone->zone_title; ?></div>
					...
					<div class="col-12 col-md-4 col-lg-4">
						...
						<div class="counter"><?= $ville->city_title; ?></div>
				...
				<table class="table p-display-info-list">
					...
					<tbody>
						...
						<tr>
							...
							<td class="icon"><i class="fas fa-street-view"></i></td>

							<td class="item">Dénomination</td>

							<td class="text-uppercase"><?= $commune->cmune_title; ?></td>

						</tr>
						
						<tr>
							
							<td class="icon"><i class="fas fa-map-marked-alt"></i></td>

							<td class="item">Ville d'appartenance</td>
						...
						<tr>
							...
							<td class="item">Zone d'appartenance</td>
