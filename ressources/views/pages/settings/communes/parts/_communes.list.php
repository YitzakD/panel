		...
		<div class="p-portlet rounded">
			...
			<div class="p-portlet-head">
				...
				<div class="p-portlet-head-label">
					<h3>Ajouté récemment<small class="p-hidden">Total <?= $communescounter__; ?></small></h3>
				</div>
			...
			<div class="d-block pt-4 pb-4">
				...
				<table class="table table-striped p-datatable">
					...
					<thead>
 					...
 					<?php if($communescounter__ > 0): ?>

 						<?php foreach($communes__ as $item): ?>
						...
						<?php $ville = find_one("cities", "id", $item->vid) ?>
 						...
 						<tr>
 							...
 							<td><?= ucfirst($item->cmune_title); ?></td>

 							<td><?= ucfirst($zone->zone_title); ?></td>

 							<td><?= ucfirst($ville->city_title); ?></td>
 					...
 					<?php else: ?>
 						...
 						<tr>
 							...
 							<td colspan="6" class="p-datatable-empty">
 								...
 								<p>Vous n'avez aucune communes pour le moment</p>
			...
			<div class="p-portlet-foot">
				...
				<?php if($communescounter__ > $limit): ?>
