	...
	<div class="p-portlet-body">
		...
		<form action="" method="post" class="p-form-table">
			...
			<?= !empty($error[1]) 
				...
				: '<small class="text-muted">Modifiez le mot de passe de ' . $utilisateur->pseudo . '.</small>'; 
			?>

			</div>


			<button type="submit" name="usersubmit" class="btn btn-sm btn-primary p-btn-primary mb-3 mr-1 p-pill-submit">Editer</button>
