	...
	<div class="p-portlet-body">
		...
		<form action="" method="post" class="p-form-table">
			...
			<div class="form-group mb-3<?= !empty($error) && count($error[1]) != 0 ? ' has-error' : '';  ?>">
				...
				<input type="text" name="zonetitle" id="zonetitle" class="form-control p-form-ctrl p-form-ctrl-sm" value="<?= get_input("zonetitle") ?: $zone->zone_title; ?>" placeholder="Entrez le nom" autofocus required />
