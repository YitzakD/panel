		...
		<div class="p-portlet rounded">
			...
			<div class="p-portlet-head">
				...
				<div class="p-portlet-head-label">
					<h3>Ajouté récemment<small class="p-hidden">Total <?= $zonescounter__; ?></small></h3>
				</div>
			...
			<div class="d-block pt-4 pb-4">
				...
				<table class="table table-striped p-datatable">
					...
					<thead>
 					...
 					<?php if($zonescounter__ > 0): ?>

 						<?php foreach($zones__ as $item): ?>

 						<tr>
 							
 							<td scope="row"><?= $i++; ?></td>

 							<td><?= ucfirst($item->zone_title); ?></td>
