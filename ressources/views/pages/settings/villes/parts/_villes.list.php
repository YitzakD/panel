		...
		<div class="p-portlet rounded">
			...
			<div class="p-portlet-head">
				...
				<div class="p-portlet-head-label">
					<h3>Ajouté récemment<small class="p-hidden">Total <?= $villescounter__; ?></small></h3>
				</div>
			...
			<div class="d-block pt-4 pb-4">
				...
				<table class="table table-striped p-datatable">
					...
					<thead>
 					...
 					<?php if($villescounter__ > 0): ?>

 						<?php foreach($villes__ as $item): ?>
 					...
 					<?php else: ?>
 						...
 						<tr>
 							...
 							<td colspan="6" class="p-datatable-empty">
 								...
 								<p>Vous n'avez aucune villes pour le moment</p>
