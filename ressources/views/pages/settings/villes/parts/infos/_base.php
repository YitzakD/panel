		...
		<div class="p-portlet rounded">
			...
			<div class="p-portlet-head">
				...
				<div class="p-portlet-head-label">
					<?php $in = explode(" ", $ville->city_title); ?>
					...
					<span class="d-inline-block">
						<div class="text-uppercase"><?= $ville->city_title; ?></div>
						<span class="d-block small text-muted"><?= $zone->zone_title; ?></span>
					</span>
				...
				<table class="table p-display-info-list">
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-uppercase"><?= $ville->city_title; ?></td>
